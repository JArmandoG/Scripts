...
Hola, <a href="https://google.com">esta</a> es una URL!


_P=$(echo 'OXpmUFRqeFpRdDRZSENxSQ==' | base64 -d)
cat content.html | sendemail \
		-xu johndonym123@gmail.com \
		-xp $_P \
